...
class PredisenadosPage extends StatelessWidget {
  const PredisenadosPage({super.key});

  // Use the same images/order as Tradicionales: Mora, Fresa, Mango, Durazno,
  // Melocotón, Piña, Coco, Chontaduro — each item includes its own description
  List<Map<String, String>> _items() => [
    {
      'title': 'Yogurt Mora',
      'image': 'assets/images/MoraTradi.png',
      'description':
          'Yogurt de mora hecho con frutas frescas, rico en antioxidantes y sabor intenso. y con endulzantes a miel',
    },
    {
      'title': 'Yogurt Fresa',
      'image': 'assets/images/FresaTradi.png',
      'description':
          'Clásico sabor a fresa, balance perfecto entre dulzor y frescura para todo el día.',
    },
    {
      'title': 'Yogurt Mango',
      'image': 'assets/images/MangoTradi.png',
      'description':
          'Yogurt de mango con trozos y un aroma tropical que recuerda a fruta fresca.',
    },
    {
      'title': 'Yogurt Durazno',
      'image': 'assets/images/DuraznoTradi.png',
      'description':
          'Suave yogurt de durazno, ideal para desayunos y postres ligeros.',
    },
    {
      'title': 'Yogurt Melocotón',
      'image': 'assets/images/MelocotonTradi.png',
      'description':
          'Melocotón natural mezclado con yogurt cremoso; delicado y aromático.',
    },
    {
      'title': 'Yogurt Piña',
      'image': 'assets/images/PinaTradi.png',
      'description':
          'Refrescante yogurt de piña con un toque tropical y ligeramente ácido.',
    },
    {
      'title': 'Yogurt Coco',
      'image': 'assets/images/Coco.png',
      'description':
          'Cremoso yogurt con sabor a coco, perfecto para combinar con toppings crujientes.',
    },
    {
      'title': 'Yogurt Chontaduro',
      'image': 'assets/images/Chontaduro.png',
      'description':
          'Sabor exótico de la región, textura única y lleno de nutrientes.',
    },
  ];
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () async {
                        ...
                        if (res != null) {
                          // add to cart with integer prices
                          final priceMap = {
                            'Personal (300ml)': 8000,
                            '1 Litro': 20000,
                            '1.5 Litro': 30000,
              ...
              content: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      item['description'] ??
                          'Delicioso yogurt preparado con ingredientes frescos.',
